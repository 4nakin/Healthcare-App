...
/**
 * An activity representing a single ExerciseItem detail screen. This activity
...
public class ExerciseDetailActivity extends YouTubeBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_exerciseitem_detail);
		...
		if (savedInstanceState == null) {
			...
			arguments.putLong(ExerciseDetailFragment.ARG_SESSION_TIME,
					getIntent().getLongExtra(ExerciseDetailFragment.ARG_SESSION_TIME, 0L));
